...
public class SysGroupController extends BaseController
{
    ...
    @PreAuthorize("@ss.hasPermi('system:group:group')")
    @GetMapping(value = "/group/{id}")
    public AjaxResult group(@PathVariable("id") Long id)
    {
        System.out.println(sysWindbarrierMapper.selelctBarrierBygroupId(id));
        return success(sysWindbarrierMapper.selelctBarrierBygroupId(id));
